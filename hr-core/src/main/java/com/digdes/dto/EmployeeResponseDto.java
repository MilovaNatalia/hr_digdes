...
public class EmployeeResponseDto {
    ...
    public EmployeeResponseDto(Long id, String firstName, String lastName, String patronymic, String email,
                               EmployeeGender gender, Timestamp birthDate, String departmentName, String positionName) {
        this.id = id;
